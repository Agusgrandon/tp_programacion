def procesar_datos(cpu, ram, espacio_libre_gb, us_conectados, procesos_activos, estado_firewall, servidor, administrador):
    ...
    match estado_de_la_computadora:
        case "Estado critico":
            mensaje = (f"- Diagnostico del servidor {servidor}\n"
