def procesar_datos(cpu, ram, espacio_libre_gb, us_conectados, procesos_activos, estado_firewall,servidor):
...
espacio_libre_gb = int(input("Ingrese su espacio libre en disco (GB): "))
